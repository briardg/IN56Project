...
public class Administration extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(request.getParameter("question") != null && !request.getParameter("question").isEmpty() &&
				request.getParameter("reponse") != null && !request.getParameter("reponse").isEmpty()) {
			...
			try {
				...
				if(isAdmin.equals("0")) {
					...
					requete = "UPDATE utilisateur SET ESTADMIN = true WHERE ID_UTILISATEUR = "+user.getId()+";";		
					
				} else if(isAdmin.equals("1")) {
					user.setId(Integer.parseInt(request.getParameter("userId")));
					requete = "UPDATE utilisateur SET ESTADMIN = false WHERE ID_UTILISATEUR = "+user.getId()+";";				
				}
		...
		RequestDispatcher d = request.getRequestDispatcher("administration.jsp");
